import { SendEmailForgotPasswordRequest, SendEmailVerifyRequest, UserReponse, UserSignupInfoRequest, UpdateProfileRequest } from '../models/authentication/index';
export interface AuthenticationInterface {
    ...
    generateVerifyCode(request: UserSignupInfoRequest | UserReponse, additional?: {
        [key: string]: string;
    }): Promise<string>;
